...
function getFlavorByIndex(arr,numfood){
    return arr[numfood]
}
...
function removeFlavorByName(arr,removeitem){
...
function copy(newarr,oldarray){
newarr = [...oldarray];

}

copy(somearray, originalFlavors);
...
function filterByWord(arr,foodname){
    let filteredArray = [];
    for (let i = 0; i < arr.length; i++){
        if (arr[i].includes(foodname)){
